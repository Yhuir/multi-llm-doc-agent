"""UI-facing application service for task lifecycle operations."""
...
class TaskService:
    """Coordinates repositories and orchestrator for the Streamlit app."""
    ...
    def generate_toc(self, task_id: str):
        return self.orchestrator.run_parse_and_generate_toc(task_id)

    def review_toc(self, task_id: str, feedback: str):
        if not feedback.strip():
            raise ValueError("Feedback cannot be empty.")
        return self.orchestrator.review_toc(task_id, feedback)
